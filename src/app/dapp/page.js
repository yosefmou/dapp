...
const options = {
    dappMetadata: { name: "MEMESFIGHTS DAPP", url: "https://MEMESFIGHTS.vercel.app/dapp" },
    preferDesktop: false
};
...
const Betting = () => {
    ...
    const winnerHandler = async (e) => {
        e.preventDefault();
        const winnerIdInt = winnerId;
        console.log(winnerIdInt)
    ...
    const placeBetHandler = async (e) => {
        ...
        try {
            ...
            if (Number(walletSSBalance) < Number(pointTwoPercent)) {
                setErrorMsg(<span className='p-2 text-red-600 bg-transparent'>You need to have atleast 0.025% MEMESFIGHTS tokens to place bet</span>);
                return;
            }
    ...
    const getWalletBalanceHandler = async () => {
        try {
            ...
            const balanceWithTxt = "MEMESFIGHTS Balance: " + ssBalanceInEth2Decimal.toString();
    ...
    const renderRefresh = () => {
        ...
        return (
            <button onClick={connectWalletHandler} className="z-50 flex gap-2 p-5 white text-2xl bg-[#ec1d20] font-bold place-items-center lg:pointer-events-auto button-border lg:m-0 m-1">Refresh</button>
        )
    }
    ...
    const redirectToWebsiteHandler = async () => {
        window.open('https://MEMESFIGHTS.vip/', '_blank');
    }

    const redirectToTelegramHandler = async () => {
        window.open('https://t.me/MEMESFIGHTS/', '_blank');
    }
        ...
        if (!teams || teams.length === 0) {
            return (
                <div className='flex flex-col items-center w-full p-10'>
                    <h1 className='text-6xl font-bold text-white uppercase'>NO MEMES FIGHT</h1>
                ...
                <div className='mb-7'>
                    ...
                    <div className='flex flex-col lg:flex-row'>
                        {teams.map((team, index) => (
                            <div className='flex'>
                                {/* className={`flex ${index === 1 ? 'mt-5 lg:mt-64' : ''}`} */}
                                <form onSubmit={(e) => placeBetHandler(e, index)} key={index}>
                                    <div className='p-12 mx-2 my-2 bg-transparent lg:my-0 lg:p-20 lg:pt-10'>
                                        <div className='w-full lg:w-[34rem]'>
                                            <div className='p-10 text-base font-bold text-center text-white uppercase bg-black lg:text-lg team-label'>{team.id} - {team.name}</div>
                                            <img className='lg:w-[34rem] lg:h-[34rem] h-auto object-contain w-full mt-1 mb-1 fighter-img' src={`${team.name}.png`} />
                                            ...
                                            <div className="relative flex flex-col items-center">
                                                ...
                                                <div className='mt-2 mb-2 text-base font-bold text-white lg:text-lg'>Active bets: {team.totalTokenBetAmount} ETH</div>
                                                <input
                                                    name='betAmount'
                                                    type="text"
                                                    ...
                                                    className="block w-full p-5 text-base lg:text-xl font-bold text-[#ec1d20] border-[#ec1d20] border-[3px] input-field bg-white focus:ring-blue-500 focus:border-blue-500 mt-4"
                                                    placeholder="Min. 0.01 - Max. 0.1"
                                                    required
                                                />
                                                <div className="background-button">
                                                    <button type="submit" className="bet-btn">BET</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            return (
                <div className='flex flex-col items-center w-full p-10'>
                    <h1 className='text-6xl font-bold text-white uppercase'>NO MEMEFIGHTs ONLINE</h1>
                    <p className='pt-4 text-lg font-bold text-white uppercas'>Connect your wallet or wait for the admin to start one</p>
                </div>
            );
        }
    }
            ...
            if (address === owner) {
                return (
                    <div className='flex flex-col items-center w-full p-5 mt-2 bg-transparent admin-section'>
                        <h1 className='text-5xl font-bold text-white uppercase'>MEMES FIGHTS ADMIN CONTROLS</h1>
                        <div className='flex flex-col items-center w-full bg-transparent'>
                            <h1 className='p-2 text-xl font-bold text-red-500 uppercase '>{errorMsg}</h1>
                            <h1 className='p-2 text-xl font-bold text-green-500 uppercase'>{successMsg}</h1>
                        </div>
                            ...
                            <div className='p-10 winner'>
                                <div className=''>
                                    ...
                                    <div className="relative">
                                        ...
                                        <button type="submit" className="text-[#ec1d20] bg-white mt-8 w-full right-2.5 bottom-2.5 hover.bg-[#faf700] hover.text-[#000000] focus:ring-4 focus.outline-none rounded-xl text-lg px-4 py-2 font-bold">Submit Winner</button>
                                ...
                                <div className=''>
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            ...
                                            <option value="DUCK GAME">DUCK GAME</option>
                                            <option value="DUCK HUNT DOG">DUCK HUNT DOG</option>
                                            <option value="JACKY BRYANT">JACKY BRYANT</option>
                                            <option value="NUMBER MUNCHER">NUMBER MUNCHER</option>
                                            <option value="SPIDEY">SPIDEY</option>
                                            <option value="SUPER MARIO">SUPER MARIO</option>
                                            <option value="YERRR">YERRR</option>
                                        </select>

                                        <button type="submit" className="text-[#ec1d20] bg-white mt-8 w-full right-2.5 bottom-2.5 hover.bg-[#faf700] hover.text-[#000000] focus:ring-4 focus.outline-none rounded-xl text-lg px-4 py-2 font-bold">Add Fighter</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    return (
        <main className="flex flex-col items-center justify-start min-h-screen">
            ...
            <img src="spider.png" alt="Moving Image" className="moving-spider" />
            <img src="drake-img.png" alt="Moving Image" className="moving-drake" />
            <img src="pngwing.com.png" alt="Moving Image" className="moving-mario" />
            <img src="joystik.png" alt="Moving Image" className="moving-joystick" />
            <img src="hat.png" alt="Moving Image" className="moving-hat" />
            <img src="duck.png" alt="Moving Image" className="moving-duck" />
            <img src="mario2.png" alt="Moving Image" className="moving-mario-2" />
            {/* <div className="bg-[#ec1d20] text-center py-2 lg:px-4 w-full">
                <div className="flex items-center p-2 leading-none text-indigo-100 border rounded-full lg:inline-flex" role="alert">
                    <span className="flex rounded-full bg-[#ec1d20c4] border uppercase px-2 py-1 text-xs font-bold mr-3">TIP</span>
                    <span className="flex-auto mr-2 font-semibold text-left">Use Desktop for a better user experience</span>
                </div>
            </div> */}
            ...
            <div className="p-1 background-image lg:px-14 lg:pt-0 lg:pb-14">
                <div className="z-10 flex flex-col items-center justify-between w-full px-8 font-mono text-sm lg:flex-row">
                    <div className="top-0 left-0 flex justify-center w-full pt-8 pb-6 lg:static lg:w-auto lg:p-4">
                        <img className="h-60 logo" src="memesfight-logo.webp" />
                    </div>
                    <div className="left-0 flex flex-col items-end justify-center w-full bg-gradient-to-t lg:static lg:h-auto lg:w-auto lg:bg-none">
                        <div className="flex flex-col items-center justify-center w-full h-full p-4 lg:flex-row lg:p-0">
                            <p className={`${walletBalance == '' ? 'hidden' : 'mr-0 text-xl text-white lg:mr-7 flex rounded-full bg-[#ec1d20] border uppercase px-4 py-1 font-normal'}`}>{walletBalance}</p>
                            <p className={`${walletSSBalanceTxt == '' ? 'hidden' : 'lg:mt-0 mt-2 mr-0 text-xl text-white lg:mr-7 flex rounded-full bg-[#ec1d20] border uppercase px-4 py-1 font-normal'}`}>{walletSSBalanceTxt}</p>
                            <button onClick={connectWalletHandler} className="z-50 flex gap-2 p-5 white text-2xl bg-[#ec1d20] font-bold place-items-center lg:pointer-events-auto button-border lg:m-3 m-2">{walletConnectorText}</button>
                            {renderRefresh()}
                        </div>
                    </div>
                </div>

                <div className="p-2 lg:p-36">
                    <div className="flex w-full gap-5 mx-auto mt-0 text-center max-md:flex-col max-md:items-center max-md:gap-0 lg:w-3/4">
                        <div className="flex flex-col items-stretch w-full max-md:w-full max-md:ml-0">
                            <div className="flex flex-col px-5 my-auto max-md:max-w-full max-md:mt-10">
                                <div
                                    className="text-[#ec1d20] text-3xl font-bold leading-8 self-stretch -mr-5 max-md:max-w-full uppercase"
                                >
                                    Memes Collide in the Ultimate Battle Arena!
                                </div>
                                <div
                                    className="text-white text-5xl font-bold leading-[78px] self-stretch -mr-5 mt-3 max-md:max-w-full max-md:text-4xl max-md:leading-[69px]"
                                >
                                    Where Memes Clash and Laughter Takes Center Stage. Place Your Bets on the Funniest Fighters in the Ultimate Meme Showdown!
                                </div>
                                <div
                                    className="self-stretch mt-10 -mr-5 text-lg font-medium leading-8 text-white max-md:max-w-full max-md:mt-10"
                                >
                                </div>
                                <div className='flex flex-wrap items-center justify-center lg:mt-4'>
                                    <button onClick={redirectToWebsiteHandler} className=" mt-8 z-50 w-fit flex gap-2 p-5 white text-2xl bg-[#ec1d20] font-bold place-items-center lg:pointer-events-auto button-border lg:m-6 m-1">Website</button>
                                    <button onClick={redirectToTelegramHandler} className="mt-8 z-50 w-fit flex gap-2 p-5 white text-2xl bg-[#ec1d20] font-bold place-items-center lg:pointer-events-auto button-border lg:m-6 m-1">Telegram</button>
                                </div>
                            </div>
                        </div>
                        {/* <div
            ...
            <div className="p-1 lg:mb-48 lg:pl-14 lg:pr-14">
                <div className="flex flex-wrap gap-5 max-md:items-stretch max-md:gap-0">
                    <div className="flex flex-col items-center p-12 m-12 info-sec">
                        <div className='pb-5 text-5xl font-bold text-white'>MIN BET</div>
                        <div className='text-3xl font-bold text-white'>0.01 ETH</div>
                    </div>
                    <div className="flex flex-col items-center p-12 m-12 info-sec">
                        <div className='pb-5 text-5xl font-bold text-white'>MAX BET</div>
                        <div className='text-3xl font-bold text-white'>0.1 ETH</div>
                    </div>
                    <div className="flex flex-col items-center p-12 m-12 info-sec">
                        <div className='pb-5 text-5xl font-bold text-white'>HOLDING</div>
                        <div className='text-3xl font-bold text-white'>Min. 0.025%</div>
                    </div>
                </div>
            </div>
            ...
            {/* <div className='flex flex-col items-center justify-around'>
                ...
                <ol className='w-full text-left bg-[#000000] header p-8'>
                    <li className='mb-2 text-white'><strong>Fighter 1</strong> Will be on the <span className="text-[#ec1d20]">bottom left corner</span></li>
                    <li className='mb-2 text-white'><strong>Fighter 2</strong> Will be on the <span className="text-[#ec1d20]">top right corner</span></li>
            ...
            <div className='flex flex-col items-center justify-around w-full p-1 lg:p-14'>
                <div className='flex px-8 pt-8 bg-transparent mt-14'>
                    <h1 className='text-4xl font-bold text-white uppercase'>YOUTUBE STREAM</h1>
                </div>
                <iframe id="twitchIframe" className='mt-4 lg:w-[60vw] w-[95vw]' width="100%" height="400px" src="https://www.youtube.com/embed/ETwx7J9WzUA" title="🎮 Chart Fighter Mugen 🎮【 Gameplay + Link 】" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
            </div>
            ...
            {/* <div className='flex flex-col items-center justify-around p-1 lg:p-14'>
                ...
                <ol className='justify-start w-full p-8 text-left bg-transparent fire-bg'>
                    ...
                    <li className='pb-2 mx-auto my-0 text-white'>4. <strong>MEMESFIGHTS Token Power:</strong> Unlock betting prowess by holding a minimum amount of 0.025% MEMESFIGHTS tokens.</li>
