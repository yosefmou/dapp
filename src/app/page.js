...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-between min-h-screen p-4 lg:p-24">
      <div className='flex items-center justify-center px-8 py-8 mb-10 bg-white mt-14 header w-fit'>
        <a href='/dapp' className='text-4xl font-bold text-center uppercase text-[#FFAA13]'>LAUNCH  DAPP</a>
      </div>
